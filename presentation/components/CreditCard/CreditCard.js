...
import PagantisLogo from '../../../assets/pagantis-logo.png';

// #############################################################################
// ### HELPERS
// #############################################################################

const renderCardTypeLogo = (type) => {
  switch (type) {
    case CreditCardTypes.VISA:
      return <img className="visa-icon" src={VisaIcon} alt="Visa" />;
...
const CreditCard = ({ type, cardHolder, pan, contactLess, expMonth, expYear, brandName, ccv }) => (
      ...
      <div className="card">
        <div className="flip">
          <div className="front">
            ...
            <img className="logo" src={PagantisLogo} alt="Pagantis" />
            <div className="investor">{brandName}</div>
            <div className="chip">
            ...
            <div className="card-number">
              <div className="section">{pan.slice(0, 4)}</div>
              <div className="section">{pan.slice(4, 8)}</div>
              <div className="section">{pan.slice(8, 12)}</div>
              <div className="section">{pan.slice(12, 16)}</div>
            </div>
            <div className="end">
          ...
          <div className="back">
            ...
            <div className="terms">
              <p>
                This card is property of Pagantis. Misuse is criminal offence. If found, please
                return to Pagantis or to the nearest bank with MasterCard logo.
              </p>
...
CreditCard.propTypes = {
  ...
  type: PropTypes.oneOf(Object.values(CreditCardTypes)).isRequired
};
